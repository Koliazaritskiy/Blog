...
<footer class="footer-widget-section">
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="/public/images/logotip.jpg" alt=""></div>
                    ...
                    <div class="address">
                        ...
                        <p> 10009/12 ZT Streets, DC, UA</p>

                        <p> Phone: +38(096) 111 77 77</p>
                ...
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        ...
                        <div>
                            ...
                            <span class="p-date">April 07, 2017</span>
                        </div>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2017 <a href="#">Treasure PRO, </a> Built with <i
                            class="fa fa-heart"></i> by <a href="#">Niko</a>
                    </div>
                </div>
            </div>
        </div>
